    ...
    form.addEventListener('submit', async function (event) {
        ...
        if (validateForm()) {
            try {
                ...
                const res = await fetch('https://backend-dev-tfdp.4.us-1.fl0.io/api/authenticator/registro/usuarioTurista', {
                    method: 'POST',
                    headers: {
                ...
                if (resultado.redirect) {
                    ...
                    showAlert('Hubo un error al crear la cuenta. Inténtelo de nuevo.', 'error');
                }
            } catch (error) {
