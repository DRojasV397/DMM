...
async function fetchDelete(id_lugar_iti_d){
    try {
        const response = await fetch('https://backend-dev-tfdp.4.us-1.fl0.io/api/lugarItinerario/eliminarLugarItinerario', {
            method: 'POST',
...
async function fetchEditIti(lugarEditado){
    try {
        const response = await fetch('https://backend-dev-tfdp.4.us-1.fl0.io/api/lugarItinerario/editarLugarItinerario', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
